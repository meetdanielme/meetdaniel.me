...
tags:
  ...
  - "University"
draft: false
heroImage: "/images/posts/2026/student-discounts-tools-hero.jpg"
---
...
The [GitHub Student Developer Pack](https://education.github.com/pack) is the obvious place to start if you are studying programming, design, computing, or anything adjacent.
...
[DigitalOcean offers $200 in credit](https://www.digitalocean.com/github-students) through the GitHub Student Developer Pack, valid for one year for new users. 
...
[Azure for Students](https://azure.microsoft.com/en-us/free/students) gives eligible students $100 in credit without requiring a credit card.
...
JetBrains gives students and teachers the [JetBrains Student or Teacher Pack for free](https://sales.jetbrains.com/hc/en-gb/articles/207241195-Do-you-offer-free-educational-licenses-for-students-and-teachers). It includes IntelliJ IDEA Ultimate, PyCharm, WebStorm, and the rest of the JetBrains IDE family.
...
I have been using [Codédex](https://www.codedex.io/github-students) to take some additional courses in Python, HTML, CSS, and JavaScript to supplement my university courses.
...
The [Zed Student plan](https://zed.dev/education) gives verified university students Zed Pro for free for one year.
...
Being a Notion Ambassador and completely relying on Notion for organising my university notes, I can’t do anything but recommend [Notion for Education](https://www.notion.com/product/notion-for-education).
...
You can also check my [university dashboard template for Notion here](/blog/my-university-dashboard-in-notion/).
...
[Figma for Education](https://help.figma.com/hc/en-us/articles/360041061214-Figma-for-Education) gives verified higher education students free access to Figma’s Professional plan. 
...
The current [Sketch for Education](https://www.sketch.com/education/) offer gives students and educators a free Education plan. For individual students, that includes one Editor seat, 50 GB of storage, and access to the Mac app for one year, with continued free use while it remains part of your studies.
...
[KLM student tickets](https://www.klm.com/information/ticket-services/tickets-students) include one extra 23 kg checked bag, fee-free changes apart from any fare difference, and more flexible cancellation rules. The catch is that you need to be 18-29, a full-time student, and the fare is not available on every route.

[Lufthansa student fares](https://www.lufthansa.com/au/en/local-page/student-fares) are more route-dependent. Most student fares include two checked bags of 23 kg each, though flights from the US are listed with one 23 kg bag, and they are not offered for bookings within Europe.
...
Moreover, in Ireland, many universities’ student unions offer the [My AMLÉ app](https://myamle.ie), featuring more local discount options.
