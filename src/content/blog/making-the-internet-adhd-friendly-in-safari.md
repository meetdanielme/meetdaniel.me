...
Since my complete switch to the Apple ecosystem 10 years ago, I have been a Safari user for most of my personal browsing[1](#fn1-6453 "see footnote"). It’s fast, battery-efficient, prioritizes privacy, and seamlessly integrates with Apple’s devices and services. But I also like it for its simple, clutter-free interface that can be stripped down to the absolute minimum while still maintaining full functionality.
...
![safari reader](/images/posts/2025/safari-reader.png)
...
The other feature that Apple added with iOS 18 is Distraction Control, which lets you _[Thanos-snap](https://en.wikipedia.org/wiki/The_Blip)_ any element on a website with one of the coolest animations that I have seen in a piece of software since transitions in Keynote (seriously, kudos to whoever created it).
...
My biggest focus kryptonite is YouTube. If my self-control is particularly low on a given day, I can find myself watching random videos for hours on end. I have tried to fight it in many ways, but sooner or later I’d give up and go back to this nasty habit of mine. Luckily, one of the videos that the algorithm has brought to my attention was [this one from Reysu](https://www.youtube.com/watch?v=7jVb1lLniEw), where he introduced me to two Safari extensions I have never heard of before.

[SocialFocus](https://socialfocus.app) and [UnTrap](https://untrap.app), both made by the same developer, disable distracting elements or entire sections of social media websites and YouTube. UnTrap is specifically designed for YouTube, giving you control over pretty much everything you can imagine, whereas SocialFocus also supports other social media websites. Both extensions work on macOS, iOS, and iPadOS. There are also versions for Chrome and Firefox.

<figure>

![socialfocus in safari](/images/posts/2025/socialfocus-in-safari-1024x680.png)
...
UnTrap also has a feature that lets you replace YouTube’s own video player with a system-native HTML5 viewer, which supports Picture-In-Picture out of the box. In my experience, it’s quite buggy, so I have stacked with another extension I have been using for a while that does the same thing called [Vinegar](https://apps.apple.com/app/vinegar-tube-cleaner/id1591303229?l=en-GB). Its developer, _And a Dinosaur_ (awesome name), has created other utilities helping reduce distractions, like [Spool](https://apps.apple.com/app/spool-for-safari/id6737591230?l=en-GB) for Threads and [Lucky](https://apps.apple.com/app/lucky-for-safari/id6627338771?l=en-GB) for Google.

<figure>

![untrap for youtube](/images/posts/2025/untrap-for-youtube-1024x680.png)
...
![My Recurring Session in Opal](/images/posts/2025/opal-scheduled-session.png)
