...
Inspired by Myke Hurley and CGP Grey from [Cortex](https://www.relay.fm/cortex), I’ve been setting [Yearly Themes](https://www.youtube.com/watch?v=NVGuFdX5guE) for the past few years. Rather than aiming for a specific outcome like a New Year’s Resolution, Yearly Themes are about finding an overarching focus that guides your goals throughout the year.

My theme for 2025 is _the year of knowledge and focus_:
...
I also have a few _ideal outcomes_ for my theme:
...
I keep track of my Yearly Theme (and all other goals mentioned below) in [Apple Notes](/blog/why-i-chose-apple-notes-with-forever-notes-over-obsidian-and-notion/), but Cortex also offers a physical [Theme System Journal](https://www.themesystem.com). Their product website also does a great job explaining what it takes to create a successful theme.
...
My repeating Weekly Review project in Things 3
...
These questions get added to my Sunday daily note in Apple Notes using a Shortcuts automation (I explain [how that works here](/blog/why-i-chose-apple-notes-with-forever-notes-over-obsidian-and-notion/)).
...
![things 3 daily review](images/things-3-daily-review.png)

<figcaption>

My repeating Daily Review project in Things 3
...
![apple fitness plus meditations](images/apple-fitness-plus-meditations.png)
...
For meditation, I use [Apple Fitness+](/blog/one-year-with-apple-fitness/) guided sessions. For journaling, I prefer a physical notebook and a LAMY Safari fountain pen — handwriting helps me connect with my emotions more easily.

## Calendar and Time Blocking

I can’t imagine how chaotic my life would be without calendar apps. I switch between Apple Calendar and Notion Calendar (the latter lacks iPadOS/watchOS apps but has an _excellent_ scheduling tool).
...
Still, I often need help stopping myself from compulsively checking apps and websites when my mind starts to wander. I’ve written dedicated posts on using [Opal](/blog/how-i-use-opal-to-stay-focused-with-adhd/) across my Apple devices and [Safari extensions](/blog/making-the-internet-adhd-friendly-in-safari/) to reduce web distractions.

<figure>

![minimal safari browser](images/minimal-safari-browser.png)

<figcaption>

My distraction-free Safari setup

</figcaption>

</figure>

I also keep my devices as clean and minimal as possible. I have more apps installed than I’d like to admit (well, except on my [64 GB iPad Pro](/blog/living-with-a-2018-ipad-pro-in-2025/)), but I keep [Home Screens](/blog/my-iphone-homescreen-2025/) and Docks minimal — launching apps with [Raycast](/blog/how-i-use-raycast-on-my-mac/) on Mac or Spotlight on iOS/iPadOS.
...
What matters most is figuring out what works for _you_, being consistent, and giving yourself grace when you fall out of routine.
